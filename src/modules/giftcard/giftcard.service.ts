...
export class GiftcardService extends GenericService(
  ...
  async createGiftCardPurchase(payload: CreateGiftCardProviderDTO): Promise<any> {
    ...
    try {
      ...
      this.logger.debug({
        message: 'Converted rate fetched',
